require(['../lib/squire', 'test/MockTimer', 'test/MockTimeUtil'], function(Squire, MockTimer, MockTimeUtil) {

    var squire = new Squire();
    squire.mock('js/Timer', MockTimer);
    squire.mock('js/TimeUtil', MockTimeUtil);

    squire.require(['js/ActivityTimeAccumulator', 'js/Activity', 'js/Session'], function(ActivityTimeAccumulator, Activity, Session) {
